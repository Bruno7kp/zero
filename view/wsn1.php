			...
			<section>
				<div class="container">
					...
					<div class="row bottomspace-md text-center">
						<div class="col-xs-12">
							<h3 class="h3">
                                <?php echo Lang::get("weeks_sequel_no1"); ?>
							</h3>
						</div>
					</div>
						...
						?>
							<table class="table middle divider tablesorter">
								...
								<tr>
									...
									<th class="text-center"><?php echo Lang::get('weeks_sequel');?></th>
								...
								<tr>
									...
									<td class="text-center"><?php echo "<a href='".$url."'>".$value->last_week_of_streak."</a>"; ?></td>
								</tr>
								<?php 
								}
								?>
