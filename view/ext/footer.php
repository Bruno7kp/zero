...
<footer id="fh5co-footer">
	<div class="container">
		...
		<p class="text-muted fh5co-no-margin-bottom text-center"><small>&copy; 2016 <a href="#"><?php echo App::get("name");?></a> <a href="<?php echo Route::url('zero_versions');?>"><?php echo App::get("version");?></a>.</small></p>
