...
<?php
	...
	$blocktitle = "<img height='174' src='".$lfm_image."'>";
?>
						...
						<div class="col-xs-12">
							<div class="">
								...
								<div class="col-md-2 col-sm-4 col-xs-6 text-center divider">
									...
									<br/>
									<strong>
									<i class="ti-calendar ico-color"></i>
					...
					<div class="row">
						<div class="col-xs-12">
							<small class="text-muted" id="notes">
								¹ = <small>Número de usuários que colocaram este álbum em algum de seus charts semanais</small> 
								<br/>
								² = <small>Números de usuário que colocaram este álbum em #1 em algum de seus charts semanais</small>  
								<br/>
								³ = <small>Soma de semanas em #1 entre todos os charts/usuários</small>  
								<br/>
								* = <small>Usuário com maior número de semanas em #1 deste álbum</small>
							</small>
						</div>
					</div>
				</div>
