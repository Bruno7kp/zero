			...
			<section>
				<div class="container">
					...
					<div class="row bottomspace-md text-center">
						<div class="col-xs-12">
							<h3 class="h3">
                                <?php echo Lang::get("weeks_to_no1"); ?>
							</h3>
						</div>
					</div>
						...
						?>
							<table class="table middle divider tablesorter">
								...
								<tr>
									...
									<th class="text-center"><?php echo Lang::get('wk_to_pk');?></th>
								...
								<tr>
									...
									<?php } ?>
									<td class="text-center"><?php echo $value->weeks_before_no1; ?></td>
									<td class="text-center"><?php echo "<a href='".$url."'>".$value->week_no1."</a>"; ?></td>
								</tr>
								<?php 
								}
								?>
