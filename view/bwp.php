						...
						<div class="col-xs-12 col-md-6">
							...
							<div class="row">
								<div class="col-xs-3 col-xs-offset-3 col-sm-2 col-sm-offset-4 col-md-offset-0 col-md-2 text-center">
									...
									{
									?>
								<option <?php echo ($signal == $value ? "selected='selected'" : "");?>value="<?php echo Route::url(strpos($curRoute, "at") !== false ? $curRoute : str_replace("bwp", "bwp_at", $curRoute), array('login' => $user->login, 'type' => $type, 'top' => $top, 'signal' => $value, 'year' => $year));?>">
									<?php echo $value;?>
									</option>
									<?php
									}
								...
								<div class="col-xs-3 col-sm-2 col-md-2">
									...
									{ 
									?>
									<option <?php echo ($top == $i+1 ? "selected='selected'" : "");?>value="<?php echo Route::url(strpos($curRoute, "at") !== false ? $curRoute : str_replace("bwp", "bwp_at", $curRoute), array('login' => $user->login, 'type' => $type, 'top' => ($i+1), 'signal' => $signal, 'year' => $year));?>">
									<?php echo $i+1;?>
									</option>
									<?php
									}
