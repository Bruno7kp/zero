					...
					<div class="row" id="intro">
						...
						<div class="col-md-10 col-sm-8 text-justify" id="fh5co-content">
							...
							<ul>
								...
								<li>Nos charts e na página de música, é mostrado a foto do artista e não a da capa do álbum onde ela está presente</li>
