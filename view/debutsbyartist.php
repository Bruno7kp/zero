					...
					<div class="row text-center">
						<div class="col-xs-12">
							<div class="btn-group" role="group">
								<a href="<?php echo Route::url($curRoute, array('login' => $user->login, 'type' => 'album', 'top' => $top, 'signal' => $signal, 'year' => $year));?>" class="no-margin btn btn-custom btn-info"><i class="ti-user"></i> <i class="icon-vynil except"></i></a>
								<a href="<?php echo Route::url($curRoute, array('login' => $user->login, 'type' => 'music', 'top' => $top, 'signal' => $signal, 'year' => $year));?>" class="no-margin btn btn-custom btn-info"><i class="ti-user"></i> <i class="ti-music"></i></a>
							</div>
						</div>
					</div>
						...
						<div class="col-xs-12 col-md-6">
							...
							<div class="row">
								<div class="col-xs-3 col-xs-offset-3 col-sm-2 col-sm-offset-4 col-md-offset-0 col-md-2 text-center">
									...
									{
									?>
									<option <?php echo ($signal == $value ? "selected='selected'" : "");?>value="<?php echo Route::url(strpos($curRoute, "main") !== false ?  str_replace("_main", "", $curRoute) : $curRoute, array('login' => $user->login, 'type' => $type, 'top' => $top, 'signal' => $value, 'year' => $year));?>">
									<?php echo $value;?>
									</option>
									<?php
									}
								...
								<div class="col-xs-3 col-sm-2 col-md-2">
									...
									{ 
									?>
									<option <?php echo ($top == $i+1 ? "selected='selected'" : "");?>value="<?php echo Route::url(strpos($curRoute, "main") !== false ?  str_replace("_main", "", $curRoute) : $curRoute, array('login' => $user->login, 'type' => $type, 'top' => ($i+1), 'signal' => $signal, 'year' => $year));?>">
									<?php echo $i+1;?>
									</option>
									<?php
									}
