    ...
    <Box>
      ...
      >
        <Flex direction="column" align="center" style={{ zIndex: 1, textAlign: 'center' }}>
          <Image src="/zero-white.png" radius="md" h={80} w="auto" fit="contain" />
          <Text size="xl" mt="md" c="white" style={{ textShadow: '1px 1px 2px rgba(0,0,0,0.5)' }}>
      ...
      <Container py="xl" my="xl">
        ...
        <SimpleGrid cols={{ base: 1, md: 3 }} spacing="xl" verticalSpacing="lg" mt="xl">
          <Card
            shadow="sm"
            padding="lg"
            radius="md"
