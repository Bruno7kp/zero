export const KEYS = {
  ...
  ARTIST_ALBUMS_SHOW_SALES: 'zc.artist.albumsShowSales:v1',
  ARTIST_ALBUMS_SHOW_CERT: 'zc.artist.albumsShowCert:v1',
  ARTIST_TRACKS_SHOW_SALES: 'zc.artist.tracksShowSales:v1',
  ARTIST_TRACKS_SHOW_CERT: 'zc.artist.tracksShowCert:v1',
