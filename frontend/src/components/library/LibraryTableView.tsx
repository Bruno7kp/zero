...
export const LibraryTableView: React.FC<LibraryTableViewProps> = ({
  ...
  const pointsWeight =
    type === 'track' ? chart?.music_points_weight || 0 : chart?.album_points_weight || 0;
  const playsWeight =
    type === 'track' ? chart?.music_plays_weight || 0 : chart?.album_plays_weight || 0;
            ...
            <Table.Thead>
              <Table.Tr>
                ...
                {visibleColumns.weeks && (
                  <Table.Th style={{ width: 85, textAlign: 'center' }}>
                    {t('charts.weeks')}
                  </Table.Th>
                )}
                ...
                {showSales && visibleColumns.sales && (
                  <Table.Th tt="capitalize" style={{ width: 80, textAlign: 'center' }}>
                    {chart?.formula_name || 'Sales'}
                  </Table.Th>
                )}
