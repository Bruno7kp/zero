...
export const BadgeStylePreview: React.FC<BadgeStylePreviewProps> = ({ kind, rankCfg, playsCfg }) => {
  ...
  return (
    <Stack gap={8} mt={4} align="center">
      <Text fw={600} size="sm" ta="center" style={{ width: '100%' }}>{t('charts.badgeStyles.field_preview')}</Text>
