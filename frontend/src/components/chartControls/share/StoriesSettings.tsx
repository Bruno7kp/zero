    ...
    <Accordion.Item value="stories-settings">
      <Accordion.Control>
        <Flex direction="column" gap={2}>
          <Flex align="center" gap={8}><IconPhoto size={16} /><Text fw={600}>{t('charts.share.storiesSettings', 'Stories Settings')}</Text></Flex>
          <Text size="xs" c="dimmed">{t('charts.share.storiesSettingsDescription', 'Customize your stories image')}</Text>
        </Flex>
      </Accordion.Control>
      <Accordion.Panel>
        <Stack gap="md">
          ...
          <div>
            <Text size="sm" fw={500} mb="xs">{t('charts.share.primaryColor', 'Primary Color')}</Text>
            <Text size="xs" c="dimmed" mb="xs">{t('charts.share.primaryColorDescription', 'Color for rank badges and header number')}</Text>
            <ColorInput
          ...
          <div>
            <Text size="sm" fw={500} mb="xs">{t('charts.share.highlightColor', 'Highlight Color')}</Text>
            <Text size="xs" c="dimmed" mb="xs">{t('charts.share.highlightColorDescription', 'Color for the #1 position highlight')}</Text>
            <ColorInput
