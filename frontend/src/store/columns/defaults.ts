...
export const defaultColumns: ColumnConfig[] = [
  ...
  {
    key: 'name',
    label: 'charts.titleLabel',
    labelComplete: 'charts.titleLabel',
    visible: true,
    isColumn: true,
  },
  {
    key: 'artist',
    label: 'charts.artistLabel',
    labelComplete: 'charts.artistLabel',
    visible: false,
    isColumn: true,
  },
  ...
  {
    key: 'altPlaysVariation',
    label: 'charts.altPlaysVariationLabel',
    visible: false,
    isColumn: true,
  },
  { key: 'deltaPlaysBadge', label: 'charts.deltaPlaysLabel', visible: false, isColumn: false },
  {
    key: 'deltaPercentPlaysBadge',
    label: 'charts.deltaPercentPlaysLabel',
    visible: true,
    isColumn: false,
  },
  {
    key: 'peak',
    label: 'charts.peak',
    labelComplete: 'charts.peakLabel',
    visible: true,
    isColumn: true,
  },
  {
    key: 'totalWeeks',
    label: 'charts.weeks',
    labelComplete: 'charts.weeksLabel',
    visible: true,
    isColumn: true,
  },
];
...
export const DEFAULT_VIEW_SETTINGS: Record<'table' | 'list' | 'grid', ViewSettings> = {
  table: {
    containerSize: 'md',
    fontScale: 0,
    rankVariationLocation: 'under',
    playsVariationLocation: 'under',
    playsVariationDisplay: 'percent',
    peakCountStyle: 'noCount',
    tableBackground: 'default',
    artistDisplayMode: 'under',
  ...
  list: {
    containerSize: 'md',
    fontScale: 0,
    rankVariationLocation: 'column',
    playsVariationLocation: 'under',
    playsVariationDisplay: 'percent',
    peakCountStyle: 'noCount',
    listBackground: 'default',
    listPeakWeeksCombined: false,
    showDroppedItems: false,
    showFormulaInsteadOfPlays: false,
    showCarousel: false,
  },
